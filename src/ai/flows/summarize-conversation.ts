...
/**
 * @fileOverview Summarizes a conversation given a conversation history.
 *
...
const SummarizeConversationInputSchema = z.object({
  conversationHistory: z
    .string()
    .describe('The full history of the conversation to summarize.'),
});
...
const prompt = ai.definePrompt({
  ...
  Please provide a concise and informative summary of the following conversation history:
